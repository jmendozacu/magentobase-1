...
#            if (req.http.X-Varnish-Esi-Method == "esi" && req.esi_level == 0 && !({{debug_headers}} || client.ip ~ debug_acl)) {
            if (req.http.X-Varnish-Esi-Method == "esi" && req.esi_level == 0 && !(client.ip ~ debug_acl)) {
