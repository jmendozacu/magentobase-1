...
class Made_Cache_Model_VarnishObserver
{
    ...
    public function initializeResponseHeaders(Varien_Event_Observer $observer)
    {
        ...
        Mage::log('INTIT: ' .$observer->getEvent()->getControllerAction()->getRequest()->getControllerName());
        Mage::log('INTIT1: ' .$observer->getEvent()->getControllerAction()->getRequest()->getActionName());
        Mage::log('INTIT2 route: ' .$observer->getEvent()->getControllerAction()->getRequest()->getRouteName());
    ...
    public function setVarnishCacheHeaders(Varien_Event_Observer $observer)
    {
        ...
        Mage::log('CONTRRO: ' .$controller->getRequest()->getControllerName());
    ...
    public function addEsiTag(Varien_Event_Observer $observer)
    {
        ...
        if ($block->getData('esi')) {
            ...
            Mage::log('ESIIIII: ' .$block->getNameInLayout());
